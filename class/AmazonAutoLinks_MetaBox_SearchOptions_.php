...
abstract class AmazonAutoLinks_MetaBox_SearchOptions_ extends AmazonAutoLinks_AdminPageFramework_MetaBox {
	...
	public function setUp() {
		...
		foreach( $oSearchOptionFields->getFieldsOfSecondTab( '', '' ) as $arrField ) {
			
			// remove the prefix for the field ID
			// $arrField['strFieldID'] = preg_replace( '/^search_/', '', $arrField['strFieldID'] );
			// $arrField['strFieldID'] = preg_replace( '/^search2_/', '', $arrField['strFieldID'] );
