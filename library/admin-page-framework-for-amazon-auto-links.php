...
abstract class AmazonAutoLinks_AdminPageFramework_SettingsAPI extends AmazonAutoLinks_AdminPageFramework_Menu {
	...
	*/	
	...
	private function addTaxonomyChecklistScript( &$arrField ) {
		...
		// Append the script
		$this->oProps->strScript .= AmazonAutoLinks_AdminPageFramework_Properties::getTaxonomyChecklistScript();
	...
	protected function renderSettingField( $strFieldID, $strPageSlug ) {
		...
		$oField = new AmazonAutoLinks_AdminPageFramework_InputField( $arrField, $this->oProps->arrOptions, $this->arrFieldErrors, $this->oMsg );
...
abstract class AmazonAutoLinks_AdminPageFramework extends AmazonAutoLinks_AdminPageFramework_SettingsAPI {
    ...
    */			
	...
	public function __construct( $strOptionKey=null, $strCallerPath=null, $strCapability=null, $strTextDomain=null ){
		...
		// Objects
		$this->oProps = new AmazonAutoLinks_AdminPageFramework_Properties( $strClassName, $strOptionKey, $strCapability );
		$this->oMsg = new AmazonAutoLinks_AdminPageFramework_Messages( $strTextDomain );
		$this->oUtil = new AmazonAutoLinks_AdminPageFramework_Utilities;
		$this->oDebug = new AmazonAutoLinks_AdminPageFramework_Debug;
		$this->oLink = new AmazonAutoLinks_AdminPageFramework_Link( $this->oProps, $strCallerPath );
	...
	*/	
	...
	public function addStyle() {
		...
		echo "<style type='text/css' id='admin-page-framework-style'>" 
			. $this->oUtil->addAndApplyFilters( $this, $this->oUtil->getFilterArrayByPrefix( self::$arrPrefixes['style_'], $this->oProps->strClassName, $strPageSlug, $strTabSlug, false ), AmazonAutoLinks_AdminPageFramework_Properties::$strDefaultStyle )
			. "</style>";
		echo "<!--[if IE]><style type='text/css' id='admin-page-framework-style-for-IE'>" 
			. $this->oUtil->addAndApplyFilters( $this, $this->oUtil->getFilterArrayByPrefix( self::$arrPrefixes['style_'], $this->oProps->strClassName, $strPageSlug, $strTabSlug, false ), AmazonAutoLinks_AdminPageFramework_Properties::$strDefaultStyleIE )
			. "</style><![endif]-->";
...
abstract class AmazonAutoLinks_AdminPageFramework_PostType {	
	...
	*/
	public function __construct( $strPostType, $arrArgs=array(), $strCallerPath=null ) {
		...
		// Objects
		$this->oUtil = new AmazonAutoLinks_AdminPageFramework_Utilities;
		$this->oProps = new AmazonAutoLinks_AdminPageFramework_PostType_Properties;
		...
		if ( $this->oProps->strPostType != '' && is_admin() ) {			
			...
			// Links
			$this->oLink = new AmazonAutoLinks_AdminPageFramework_LinkForPostType( $this->oProps->strPostType, $this->oProps->strCallerPath );
...
abstract class AmazonAutoLinks_AdminPageFramework_MetaBox extends AmazonAutoLinks_AdminPageFramework_MetaBox_Help {
	...
	*/ 		
	...
	function __construct( $strMetaBoxID, $strTitle, $vPostTypes=array( 'post' ), $strContext='normal', $strPriority='default', $strCapability='edit_posts', $strTextDomain='admin-page-framework' ) {
		...
		$this->oMsg = new AmazonAutoLinks_AdminPageFramework_Messages( $strTextDomain );
		$this->oDebug = new AmazonAutoLinks_AdminPageFramework_Debug;
		$this->oProps = new AmazonAutoLinks_AdminPageFramework_MetaBox_Properties;
	...
	*/		
	...
	public function addStyle() {
		...
		// Print out the filtered styles.
		$this->oProps->strStyle = $this->oUtil->addAndApplyFilters( $this, "style_{$this->oProps->strClassName}", AmazonAutoLinks_AdminPageFramework_Properties::$strDefaultStyle );
		$this->oProps->strStyleIE = $this->oUtil->addAndApplyFilters( $this, "style_ie_{$this->oProps->strClassName}", AmazonAutoLinks_AdminPageFramework_Properties::$strDefaultStyleIE );
		if ( ! empty( $this->oProps->strStyle ) )
