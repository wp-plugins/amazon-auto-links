...
class AmazonAutoLinks_AdminPageFramework_Property_NetworkAdmin extends AmazonAutoLinks_AdminPageFramework_Property_Page {
    ...
    protected function _getOptions() {
        return AmazonAutoLinks_AdminPageFramework_WPUtility::addAndApplyFilter($GLOBALS['aAmazonAutoLinks_AdminPageFramework']['aPageClasses'][$this->sClassName], 'options_' . $this->sClassName, $this->sOptionKey ? get_site_option($this->sOptionKey, array()) : array());
    }
