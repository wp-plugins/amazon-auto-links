 ...
 */
abstract class AmazonAutoLinks_AdminPageFramework_FormField_Base extends AmazonAutoLinks_AdminPageFramework_FormOutput {
    public $aField = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new AmazonAutoLinks_AdminPageFramework_Script_Widget;
        ...
        new AmazonAutoLinks_AdminPageFramework_Script_Utility;
        new AmazonAutoLinks_AdminPageFramework_Script_OptionStorage;
        new AmazonAutoLinks_AdminPageFramework_Script_AttributeUpdator;
        new AmazonAutoLinks_AdminPageFramework_Script_RepeatableField($this->oMsg);
        new AmazonAutoLinks_AdminPageFramework_Script_Sortable;
        new AmazonAutoLinks_AdminPageFramework_Script_RegisterCallback;
    }
