...
abstract class AmazonAutoLinks_AdminPageFramework_Factory_Model extends AmazonAutoLinks_AdminPageFramework_Factory_Router {
    ...
    protected function _loadFieldTypeDefinitions() {
        if (empty(self::$_aFieldTypeDefinitions)) {
            self::$_aFieldTypeDefinitions = AmazonAutoLinks_AdminPageFramework_FieldTypeRegistration::register(array(), $this->oProp->sClassName, $this->oMsg);
        }
    ...
    protected function _isValidationErrors() {
        if (isset($GLOBALS['aAmazonAutoLinks_AdminPageFramework']['aFieldErrors']) && $GLOBALS['aAmazonAutoLinks_AdminPageFramework']['aFieldErrors']) {
            return true;
        }
    ...
    public function _replyToSaveFieldErrors() {
        if (!isset($GLOBALS['aAmazonAutoLinks_AdminPageFramework']['aFieldErrors'])) {
            return;
        }
        $this->oUtil->setTransient("apf_field_erros_" . get_current_user_id(), $GLOBALS['aAmazonAutoLinks_AdminPageFramework']['aFieldErrors'], 300);
    }
    public function _replyToSaveNotices() {
        if (!isset($GLOBALS['aAmazonAutoLinks_AdminPageFramework']['aNotices'])) {
            return;
        }
        if (empty($GLOBALS['aAmazonAutoLinks_AdminPageFramework']['aNotices'])) {
            return;
        }
        $this->oUtil->setTransient('apf_notices_' . get_current_user_id(), $GLOBALS['aAmazonAutoLinks_AdminPageFramework']['aNotices']);
    }
