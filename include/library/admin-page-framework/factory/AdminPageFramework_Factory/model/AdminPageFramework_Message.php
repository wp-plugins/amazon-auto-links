...
class AmazonAutoLinks_AdminPageFramework_Message {
    ...
    public static function getInstance($sTextDomain = 'amazon-auto-links') {
        $_oInstance = isset(self::$_aInstancesByTextDomain[$sTextDomain]) && (self::$_aInstancesByTextDomain[$sTextDomain] instanceof AmazonAutoLinks_AdminPageFramework_Message) ? self::$_aInstancesByTextDomain[$sTextDomain] : new AmazonAutoLinks_AdminPageFramework_Message($sTextDomain);
    ...
    private function __doDummy() {
        ...
        __('Not all form fields could not be sent. Please check your server settings of PHP <code>max_input_vars</code> and consult the server administrator to increase the value. <code>max input vars</code>: %1$s. <code>$_POST</code> count: %2$s', 'amazon-auto-links');
        ...
        __('Powered by', 'amazon-auto-links');
