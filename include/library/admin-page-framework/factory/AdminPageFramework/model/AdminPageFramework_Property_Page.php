 ...
 */
class AmazonAutoLinks_AdminPageFramework_Property_Page extends AmazonAutoLinks_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['aAmazonAutoLinks_AdminPageFramework']['aPageClasses'] = isset($GLOBALS['aAmazonAutoLinks_AdminPageFramework']['aPageClasses']) && is_array($GLOBALS['aAmazonAutoLinks_AdminPageFramework']['aPageClasses']) ? $GLOBALS['aAmazonAutoLinks_AdminPageFramework']['aPageClasses'] : array();
