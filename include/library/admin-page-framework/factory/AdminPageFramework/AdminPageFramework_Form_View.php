 ...
 */
abstract class AmazonAutoLinks_AdminPageFramework_Form_View extends AmazonAutoLinks_AdminPageFramework_Form_Model {
    ...
    public function _replyToGetFieldOutput($aField) {
        ...
        $_oField = new AmazonAutoLinks_AdminPageFramework_FormField($aField, $_aTemp, $this->aFieldErrors, $this->oProp->aFieldTypeDefinitions, $this->oMsg, $this->oProp->aFieldCallbacks);
