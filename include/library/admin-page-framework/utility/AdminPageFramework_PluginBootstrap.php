 ...
 */
abstract class AmazonAutoLinks_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('AmazonAutoLinks_AdminPageFramework_RegisterClasses')) {
            return;
        }
        new AmazonAutoLinks_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
