...
// AmazonAutoLinks_Debug::logArray( 'passed number of units: ' .  count( $arrUnits ) );		
...
// AmazonAutoLinks_Debug::logArray( 'created number of units: ' .  count( $intCount ) );				
		return $intCount;
...
// AmazonAutoLinks_Debug::logArray( 'Could not post unit' );				
			return false;
		}
// AmazonAutoLinks_Debug::logArray( 'Created: ' . $intPostID );						
...
// AmazonAutoLinks_Debug::logArray( $vTerm );				
}
